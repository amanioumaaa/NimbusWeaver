...
#[derive(Debug)]
pub struct NimbusWeaverProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NimbusWeaverProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NimbusWeaver processing");
    
    let mut processor = NimbusWeaverProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NimbusWeaverProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NimbusWeaverProcessor::new(false);
